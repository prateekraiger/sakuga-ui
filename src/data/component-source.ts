...
export const BENTO2_CODE = `import React from 'react';
...
const TaniaLanding: React.FC = () => {
  ...
  return (
    <div className="bg-[#fcfcfc] text-[#0a0a0a] min-h-screen font-sans antialiased selection:bg-[#0a0a0a] selection:text-white overflow-x-hidden w-full">
      ...
      {/* Navigation */}
      <header className="fixed top-0 left-0 right-0 z-50 transition-all duration-300 bg-[#fcfcfc]/90 backdrop-blur-sm border-b border-black/5">
      ...
      {/* Featured Feature: Video/Mood */}
      {/* Fixed: Grid layout overlap and overflow issues */}
      <section className="relative w-full py-24 bg-[#0a0a0a] text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          {/* Image composition - Fixed container constraints */}
